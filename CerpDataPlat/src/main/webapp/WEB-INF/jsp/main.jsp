                ...
                <ul style="padding-left:0px;" class="list-group">
                    ...
                    <li class="list-group-item tree-closed">
                        ...
                        <ul style="margin-top:10px;display:none;">
                            ...
                            <li style="height:30px;">
                                <a href="#" onclick="turn('role/index')"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
                            </li>
                            <li style="height:30px;">
                                <a href="#" onclick="turn('permission/index')"><i class="glyphicon glyphicon-lock"></i> 许可维护</a>
                            </li>
                        </ul>
                    </li>
                    <%--<li class="list-group-item tree-closed">--%>
                    ...
                    <li class="list-group-item tree-closed">
                        ...
                        <ul style="margin-top:10px;display:none;">
                            <li style="height:30px;">
                                <a href="#"><i class="glyphicon glyphicon-picture"></i> 定时任务管理</a>
                            </li>
                            <%--<li style="height:30px;">--%>
